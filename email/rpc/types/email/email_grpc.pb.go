...
func (c *emailClient) SendEmail(ctx context.Context, in *UserEmailRequest, opts ...grpc.CallOption) (*UserEmailResponse, error) {
...
type EmailServer interface {
	SendEmail(context.Context, *UserEmailRequest) (*UserEmailResponse, error)
...
func (UnimplementedEmailServer) SendEmail(context.Context, *UserEmailRequest) (*UserEmailResponse, error) {
...
func _Email_SendEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServer).SendEmail(ctx, req.(*UserEmailRequest))
	}
...
var Email_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "email/rpc/email.proto",
}
